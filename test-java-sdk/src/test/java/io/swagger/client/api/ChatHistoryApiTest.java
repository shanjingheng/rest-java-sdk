...
public class ChatHistoryApiTest {
     ...
     */
    @Test
    public void orgNameAppNameChatmessagesGetTest() throws ApiException {
        String orgName = null;
        String appName = null;
        ...
        String limit = null;
        String cursor = null;
        // String response = api.orgNameAppNameChatmessagesGet(orgName, appName, authorization, ql, limit, cursor);
     ...
     */
    @Test
    public void orgNameAppNameChatmessagesTimeGetTest() throws ApiException {
        String orgName = null;
        String appName = null;
        String authorization = null;
        String time = null;
        // String response = api.orgNameAppNameChatmessagesTimeGet(orgName, appName, authorization, time);
